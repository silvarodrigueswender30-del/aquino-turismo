...
const services: Service[] = [
  {
    ...
    description: "Paraty vista do mar.",
    icon: Ship,
  },
  {
    number: "002",
    title: "Grupos & Excursões",
    description: "Receptivo e suporte para quem chega em grupo.",
    icon: Anchor,
  },
  {
    number: "003",
    title: "Day Use",
    description: "Uma opção para aproveitar o dia em Paraty.",
    icon: Waves,
  },
];
...
export function ServicesSection() {
  ...
  return (
    <section id="servicos" className="relative w-full bg-warm-sand py-16 md:py-24 scroll-mt-24">
